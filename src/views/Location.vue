                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <router-link class="btn btn-primary" to="/Add_location">Add</router-link>
                        </div>
                                    ...
                                    <tr v-for="(item) in apiData">
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap">
                                            <router-link class="btn btn-md btn-warning"
                                                :to="'/location/edit/' + item.id">Edit</router-link>
                                            &nbsp;
...
const url = import.meta.env.VITE_APP_ADMIN_API_URL + 'api/location/get';
const delete_url = import.meta.env.VITE_APP_ADMIN_API_URL + 'api/location/delete';
